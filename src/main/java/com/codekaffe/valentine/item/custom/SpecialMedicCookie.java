...
public class SpecialMedicCookie extends Item {
    ...
    public SpecialMedicCookie(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(
        ...
        tooltip.add(Text.literal("Will make you feel better.").formatted(Formatting.RED));
    }
}
