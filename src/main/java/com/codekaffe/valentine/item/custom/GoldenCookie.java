...
public class GoldenCookie extends Item {
    ...
    public static final FoodComponent FOOD_COMPONENT = new FoodComponent.Builder()
            ...
            .alwaysEdible()
            .statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 100, 1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 2400, 0), 1.0f)
            .build();

    public GoldenCookie(Settings settings) {
        super(settings);
    }
