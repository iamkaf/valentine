...
//        blockStateModelGenerator.registerSimpleState(ModBlocks.LOVEY_DOVEY_INFUSER);
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ModItems.SPOOKY_COOKIE, Models.GENERATED);
        itemModelGenerator.register(ModItems.SPECIAL_SPOOKY_COOKIE, Models.GENERATED);
        itemModelGenerator.register(ModItems.PECULIAR_COOKIE, Models.GENERATED);
        itemModelGenerator.register(ModItems.SPECIAL_PECULIAR_COOKIE, Models.GENERATED);
        itemModelGenerator.register(ModItems.PRISMATIC_COOKIE, Models.GENERATED);
